...
NvmPerfModelConstant::NvmPerfModelConstant(const core_id_t core_id, const UInt32 cache_block_size) :
...
SubsecondTime
NvmPerfModelConstant::computeQueueDelay(SubsecondTime pkt_time, SubsecondTime processing_time, const core_id_t requester,
...
void
NvmPerfModelConstant::increaseQueueDelay(const DramCntlrInterface::access_t access_type, SubsecondTime queue_delay)
{
