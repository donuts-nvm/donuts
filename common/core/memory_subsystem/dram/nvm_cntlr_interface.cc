...
//      {
//         auto now_1 = getShmemPerfModel()->getElapsedTime(ShmemPerfModel::_SIM_THREAD);
//         printf("\nnow_1: %lu %lu\n", Sim()->getClockSkewMinimizationServer()->getGlobalTime().getNS(), now_1.getNS());
//
...
//         //
//         //         shmem_msg->getPerf()->updateTime(getShmemPerfModel()->getElapsedTime(ShmemPerfModel::_SIM_THREAD),
//         //                                          shmem_msg_type == PrL1PrL2DramDirectoryMSI::ShmemMsg::NVM_WRITE_REQ ? ShmemPerf::NVM : ShmemPerf::DRAM);
//
//         auto now_2 = getShmemPerfModel()->getElapsedTime(ShmemPerfModel::_SIM_THREAD);
//         printf("now_2: %lu %lu (%lu)\n", Sim()->getClockSkewMinimizationServer()->getGlobalTime().getNS(), now_2.getNS(), (now_2 - now_1).getNS());
