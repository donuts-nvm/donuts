      ...
      UInt32 associativity, UInt32 blocksize, CacheSetInfo* set_info)
{
   switch (replacement_policy)
   {
      ...
      case CacheBase::LRU_QBS:
         return new CacheSetLRU(cache_type, associativity, blocksize, dynamic_cast<CacheSetInfoLRU*>(set_info), getNumQBSAttempts(replacement_policy, cfgname, core_id));
      ...
      case CacheBase::SRRIP_QBS:
         return new CacheSetSRRIP(cfgname, core_id, cache_type, associativity, blocksize, dynamic_cast<CacheSetInfoLRU*>(set_info), getNumQBSAttempts(replacement_policy, cfgname, core_id));
...
CacheSetInfo*
CacheSet::createCacheSetInfo(String name, String cfgname, core_id_t core_id, CacheBase::ReplacementPolicy replacement_policy, UInt32 associativity)
{
   switch (replacement_policy)
   {
      case CacheBase::LRU:
