...
protected:
   ...
   static SubsecondTime loadReadLatency() { return loadLatency("read_latency"); }
   static SubsecondTime loadWriteLatency() { return loadLatency("write_latency"); }
   static SubsecondTime loadLatency(const String& param);
};
